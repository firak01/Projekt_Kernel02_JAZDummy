package alternative.test;

import java.lang.reflect.Field;
import java.lang.reflect.Modifier;

public class ReflectionDummyZZZ {
//20170103: Nach GIT übertragen
//	!!! Diese Konstanten werden gesetzt damit per Reflection API folgende Abfrage möglich ist: DataFieldZZZ. isValidMetadataType(String sMetadataType){
	...
	public ReflectionDummyZZZ(String sAlias){
		this.Alias = sAlias;
	} 
	...
	public static boolean isValidMetadataType(String sMetadataType){
		...
		main:{
			if(sMetadataType==null || sMetadataType.equals("")) break main;
			...
			Class cl = ReflectionDummyZZZ.class;
